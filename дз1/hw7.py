...
class Guy2:
    ...
    def __init__(self, name="Guy2", job=None, home=None, car=None):
        self.name = name
        self.money = 100
        self.gladness = 50
        self.satiety = 50
...
brands_of_car = {
    "Opel": {"fuel": 100, "strength": 100, "consumption": 6},
    "Skoda": {"fuel": 50, "strength": 40, "consumption": 10},
    "Volkswagen": {"fuel": 70, "strength": 150, "consumption": 8},
    "Porsche": {"fuel": 80, "strength": 120, "consumption": 14}}
...
class Guy:
    ...
    def __init__(self, name="Guy", job=None, home=None, car=None):
        self.name = name
        self.money = 100
        self.gladness = 50
        self.satiety = 50
